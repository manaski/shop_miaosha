...
import com.gangbin.miaosha.domain.MiaoshaOrder;
import com.gangbin.miaosha.domain.MiaoshaUser;
import com.gangbin.miaosha.domain.OrderInfo;
import com.gangbin.miaosha.rabbitmq.MQSender;
import com.gangbin.miaosha.rabbitmq.MiaoshaMessage;
import com.gangbin.miaosha.redis.AccessKey;
import com.gangbin.miaosha.redis.GoodsKey;
...
import com.gangbin.miaosha.service.MiaoshaService;
...
public class MiaoshaController implements InitializingBean{
    ...
    @ResponseBody
    public String testJmeter(Model model, @RequestParam("token") String token){
    ...
    @RequestMapping(value="/do_miaosha_ajaxcache",method=RequestMethod.POST)
	@ResponseBody
...
//		}
	...
	public String toList(Model model,MiaoshaUser user,@RequestParam("goodsId") Long goodsId) {
		...
		OrderInfo orderinfo=miaoshaService.miaosha1(user,goodsvo);
		//如果秒杀成功，直接跳转到订单详情页上去。
